...
columns.push({ editor: Slick.Editors.Date, resizable: false, width: 85, id: "fecha", name: "Fecha", field: "fecha", toolTip: "DD / MM / YYYY" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 63, id: "gravedadEspecifica", name: "Grav.Esp", field: "gravedadEspecifica", toolTip: "Gravedad Específica" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 60, id: "volumen", name: "Volumen", field: "volumen", toolTip: "Volumen (MMPCD)" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 67, id: "contenidoGLP", name: "Cont.GLP", field: "contenidoGLP", toolTip: "Contenido GLP (BBL/MMPCD)" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 70, id: "poderCalorifico", name: "Poder Cal", field: "poderCalorifico", toolTip: "Poder Calorífico (BTU/PC) @ 68ºF" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 55, id: "N2", name: "N2", field: "N2" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 55, id: "CO2", name: "CO2", field: "CO2" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 55, id: "C1", name: "C1", field: "C1" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 55, id: "C2", name: "C2", field: "C2" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 55, id: "C3", name: "C3", field: "C3" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 55, id: "iC4", name: "i-C4", field: "iC4" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 55, id: "nC4", name: "n-C4", field: "nC4" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 55, id: "iC5", name: "i-C5", field: "iC5" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 55, id: "nC5", name: "n-C5", field: "nC5" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 55, id: "nC6", name: "n-C6", field: "nC6" });
columns.push({ editor: Slick.Editors.Float, resizable: false, width: 55, id: "C7", name: "C7", field: "C7" });
columns.push({ editor: Slick.Editors.LongText, resizable: false, width: 80, id: "observaciones", name: "Obs", field: "observaciones", toolTip: "Observaciones" });
columns.push({ editor: Slick.Editors.LongText, resizable: false, width: 80, id: "justificacion", name: "* Jus", field: "justificacion", toolTip: "Justificación (solo si se esta modificando el reporte de un dia pasado)" });
columns.push({ formatter: Slick.Formatters.PercentCompleteBar, resizable: false, width: 38, id: "estado", name: "", field: "estado" });
...
columnasProduccion.push({ editor: Slick.Editors.Float, resizable: false, width: 63, id: "gasolinaNatural", name: "G.Nat", field: "gasolinaNatural", toolTip: "Gasolina Natural" });
...
columnasProduccion.push({ editor: Slick.Editors.Float, resizable: false, width: 63, id: "rendimientoProdGLP", name: "R.PROD.GLP", field: "rendimientoProdGLP", toolTip: "Rendimiento Produccion GLP" });
columnasProduccion.push({ editor: Slick.Editors.Float, resizable: false, width: 63, id: "gasCombustible", name: "G.Comb", field: "gasCombustible", toolTip: "Gas Combustible" });
columnasProduccion.push({ editor: Slick.Editors.Float, resizable: false, width: 63, id: "quemaGas", name: "Q.Gas", field: "quemaGas", toolTip: "Quema Gas" });
...
columnasProduccion.push({ editor: Slick.Editors.Float, resizable: false, width: 63, id: "TVR", name: "TVR", field: "TVR", toolTip: "Tensión de Vapor Reid" });
...
columnasProduccion.push({ editor: Slick.Editors.LongText, resizable: false, width: 80, id: "observaciones", name: "Obs", field: "observaciones", toolTip: "Observaciones" });
columnasProduccion.push({ editor: Slick.Editors.LongText, resizable: false, width: 80, id: "justificacion", name: "* Jus", field: "justificacion", toolTip: "Justificación (solo si se esta modificando el reporte de un dia pasado)" });
...
columnasResidual.push({ editor: Slick.Editors.Float, resizable: false, width: 60, id: "volumen", name: "Volumen", field: "volumen", toolTip: "Volumen (MMPCD)" });
...
columnasResidual.push({ editor: Slick.Editors.LongText, resizable: false, width: 80, id: "observaciones", name: "Obs", field: "observaciones", toolTip: "Observaciones" });
columnasResidual.push({ editor: Slick.Editors.LongText, resizable: false, width: 80, id: "justificacion", name: "* Jus", field: "justificacion", toolTip: "Justificación (solo si se esta modificando el reporte de un dia pasado)" });
                    ...
                    if (DiferenciaFechas(dataProduccion[i]["fecha"], $("#txtProduccionFechaUltminoReporte").val()) > 0) {
                        $.ajax({
                            ...
                            data: JSON.stringify({
                                ...
                                umRendProdGlp: $("#ddlRendProdGlp :selected").val(),
                                umGasCombustible: $("#ddlGasCombustible :selected").val(),
                                umQuemaGas: $("#ddlQuemaGas :selected").val(),
                                umGasolinaNatural: $("#ddlGasolinaNatural :selected").val(),
                                ...
                                gasolinaNatural: serializarValor(dataProduccion[i]["gasolinaNatural"]),
                                ...
                                rendimientoProdGLP: serializarValor(dataProduccion[i]["rendimientoProdGLP"]),
                                gasCombustible: serializarValor(dataProduccion[i]["gasCombustible"]),
                                quemaGas: serializarValor(dataProduccion[i]["quemaGas"]),
...
function verificaPlanta(elemento) {
    if ($(elemento).attr('disabled') == undefined) {
        ...
        mostrarMensaje("alert", "Primero genere el reporte");
        return false;
    }
}
function verificaPlantaProde(elemento) {
    if ($(elemento).attr('disabled') == undefined) {
...
$(function () {
    ...
    $("#ddlTipoGrafico,#ddlUMedGraficoSeg").on("change", function () {
        chartRptSeguimiento.PerformCallback('chartChanged|' + $("#ddlTipoGrafico :selected").val() + '|' + $("#ddlUMedGraficoSeg :selected").val());
    });
